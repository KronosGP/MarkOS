...
namespace MarkOS.Core
{
    class DataUtilis
    {
        ...
        public static char StringToChar(string val)
        {
            ...
            {
                Console.Write("[ERROR] ", ConsoleColor.Red); Console.WriteLine("Could not convert value \"" + val + "\" to char.");
                Console.Write("[DEBUG INFO] ", ConsoleColor.Yellow); Console.WriteLine(ex.Message, ConsoleColor.Gray);
            }
            return c;
        }
        ...
        public static int StringToInt(string val)
        {
            ...
            {
                Console.Write("[ERROR] ", ConsoleColor.Red); Console.WriteLine("Could not convert value \"" + val + "\" to byte.");
                Console.Write("[DEBUG INFO] ", ConsoleColor.Yellow); Console.WriteLine(ex.Message, ConsoleColor.Gray);
            }
            return output;
        }
